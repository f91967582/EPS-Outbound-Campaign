            ...
            <Paper
              ...
              sx={{
                ...
                gridTemplateColumns: {
                  xs: "1fr",
                  sm: "1fr 1fr",
                  md: campaign.scheduledStartUtc ? "1fr 1fr 1fr 1fr" : "1fr 1fr 1fr",
                },
                gap: 2,
              }}
            >
              ...
              {campaign.scheduledStartUtc && (
                <Stack spacing={0.5}>
                  <Typography
                    ...
                    gap={0.5}
                  >
                    <EventIcon fontSize="inherit" /> PROGRAMADA
                  </Typography>
                  <Typography variant="body2">
                    {new Date(campaign.scheduledStartUtc).toLocaleString()}
                  </Typography>
                </Stack>
              )}
            </Paper>
